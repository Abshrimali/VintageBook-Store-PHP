...
<div class="main-wrapper">
        <div class="header">
            ...
            <ul class="nav user-menu float-right">
                    ...
                    <div class="dropdown-menu notifications">
                        ...
                        <div class="drop-scroll">
                            <ul class="notification-list">
                                ...
                                <?php
								$object=new data();
                        $shw =$object->appointment_information(); ;
                            ...
                            <a href="activities.html">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">'.$n_data[1].' '.$n_data[2].'</span> Just Place An Appointment Of <span class="noti-title"> DR '.$n_data[9].' '.$n_data[10].'</span></p>
                ...
                <li class="nav-item dropdown d-none d-sm-block">
                    <a href="javascript:void(0);" title="Messeges/Contact Request" id="open_msg_box" class="hasnotifications nav-link"><i class="fa fa-comment-o"></i> <span class="badge badge-pill bg-danger float-right">
                    <?php
                            $q = $object->contact_count();
							$new = mysqli_fetch_array($q);
                    ?>        
                    <?php echo $new[0]?></span></a>
                </li>
...
<span><?php echo $data['doctor_fname']?></span>
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="editdoctor.php">Edit Profile</a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="index.php"><i class="fa fa-dashboard"></i> <span>CARE</span></a>
                        </li>
                        <li class="submenu">
							<a href="#"><i class="fa fa-user-md"></i> <span> Department </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								
								<li><a href="add-department.php">Add Department</a></li>
                                <li><a  href="departments.php">Show Department</a></li>
							</ul>
						</li>
                                ...
                                echo
                                    ...
                                    <a href="chat.html">
                                        <div class="list-item">
                                            ...
                                            <div class="list-body">
                                                <span class="message-author">'.$row[1].'</span>
                                                <div class="list-body">
                                                <span class="message-author">'.$row[2].'</span>
                                                <div class="clearfix"></div>
                                                <span class="message-content">'.$row[4].'</span>
                                            </div>
