                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
							...
							<div class="dash-widget-info text-right">
								...
								$qs =$object->category_count();
								foreach($qs as $count){
									echo '<h3>'.$count["COUNT(category_id)"].'</h3>';
								}
								?>
								
								<span class="widget-title1">Categories <i class="fa fa-list" aria-hidden="true"></i></span>
							</div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
							<?php
								$qs = $object->book_count();
								foreach($qs as $count){
									echo '<h3>'.$count["COUNT(product_id)"].'</h3>';
								}
								?>
                                <span class="widget-title2">Books <i class="fa fa-book" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
							<?php
								$qs =$object->user_count();	
								foreach($qs as $count){
									echo '<h3>'.$count["COUNT(id)"].'</h3>';
								}
								?>
                                <span class="widget-title3">Clients <i class="fa fa-users" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
							<?php
								$qs =$object->count_orders();	
								foreach($qs as $count){
									echo '<h3>'.$count["COUNT(order_id)"].'</h3>';
								}
								?>
                                <span class="widget-title4">Orders<i class="fa fa-shopping-cart" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
