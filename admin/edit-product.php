...
<body>
    ...
    if (isset($_GET['id'])) {
        $product_id = $_GET['id'];
        $qu = $object->product_data($product_id);
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input name="product_name" id="name" type="text" value="<?php echo $row[1] ?>" class="form-control floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input name="product_desc" id="desc" type="text" value="<?php echo $row[2] ?>" class="form-control floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input name="product_price" id="price" type="text" value="<?php echo $row[4] ?>" class="form-control floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input name="product_stock" id="stock" type="text" value="<?php echo $row[3] ?>" class="form-control floating">

                                        </div>
                                    </div>
                                </div>
                                <div class="m-t-20 text-center">
                                    <input type="submit" class="btn btn-primary submit-btn" name="add" value="Edit product">
                                </div>
                            </div>
...
if (isset($_POST['add'])) {
    ...
    if ($product_name != "" & $product_stock != "" & $category != "" & $product_price != "" & $product_image != "" & $product_type != "" & $product_desc != "") {
        ...
        if ($txt == "jpg" or $txt == "png" or $txt == "jpeg") {
            ...
            $done =  $object->product_update($product_name,$product_desc,$product_stock,$product_price,$product_image,$category,$product_type,$product_id);
            if ($done == 1) {
                echo '<script>swal("Done", "Product update Successfully", "success")</script>';
            } else {
                echo '<script>swal("Failed", "Product Not updated ", "error")</script>';
            }
        } else {
