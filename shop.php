        ...
        <div class="col-md-6">
                <div class="product-bit-title text-center">
                    ...
                    <form method="post">
                        ...
                        <h4 class="text-dark">Search By Book Name</h4>
                        <input type="text" name="search" placeholder="Search By Name" class="form-control">
                        <input class="mt-3 col-12"  type="submit" value="Search" name="se">
                    </form>
            ...
            <div class="col-md-6">
                <div class="product-bit-title text-center">
                    ...
                    <form method="post">
                        ...
                        <h4 class="text-dark">Sort By Category</h4>
                        <select name="filter" class="form-control  text-center">
                            <option value="">---- Select Category---</option>
                            <?php
                            $a = $obj->select_category();
                            while ($row = mysqli_fetch_array($a)) {
                                echo ' <option value="' . $row[0] . '">' . $row[1] . '</option>';
                            }
                            ?>
                        </select>
                        <input class="mt-3 col-12" type="submit" value="Filter" name="check">
                    </form>
        ...
        <div class="container">
            <div class="row">
                <?php
                        ...
                        {
                            $category_id = $_POST['filter'];
                           $b = $obj -> category_join($category_id);
                        ...
                        if(!isset($_POST['check']) AND !isset($_POST['se']))
                        {
